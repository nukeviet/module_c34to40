...
<br>
<br>
- Cài lại module laws (hoặc module ảo), để xoá các bài viết và chuyên mục đã có trước đó.
<br>
<br>
...
- Copy các file của module laws cũ sang thư mục của module laws đang sử dụng của NukeViet 4
<br>
<br>
...
<form id="form-update" class="form-horizontal" action="{NV_BASE_SITEURL}index.php?{NV_LANG_VARIABLE}={NV_LANG_DATA}&amp;{NV_NAME_VARIABLE}={MODULE_NAME}&amp;{NV_OP_VARIABLE}={OP}&amp;" method="post">
    <div class="form-group">
        ...
        <div class="col-sm-20">
            <select name="nv3_laws" class="form-control">
                <!-- BEGIN: nv3_laws -->
                <option value="{NV3_LAWS.module_data}">{NV3_LAWS.module_data} ({NV3_LAWS.custom_title})</option>
                <!-- END: nv3_laws -->
            </select>
        </div>
    </div>
    <div class="form-group">
        <label class="col-sm-4 control-label">Module laws trên NukeViet 4</label>
        <div class="col-sm-20">
