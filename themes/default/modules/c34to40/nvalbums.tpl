...
<br>
<br>
- Cài lại module nvalbums (hoặc module ảo), để xoá các bài viết và chuyên mục đã có trước đó.
<br>
<br>
...
- Copy các file của module nvalbums cũ sang thư mục của module nvalbums đang sử dụng của NukeViet 4. Nhớ không copy thư mục admin_cache, albums_cache, pic_cache
<br>
<br>
- Vào phần quản lý file, ấn reload ở thư mục upload của module sau đó ấn tạo lại ảnh thumb
<br>
<br>
...
<form id="form-update" class="form-horizontal" action="{NV_BASE_SITEURL}index.php?{NV_LANG_VARIABLE}={NV_LANG_DATA}&amp;{NV_NAME_VARIABLE}={MODULE_NAME}&amp;{NV_OP_VARIABLE}={OP}&amp;" method="post">
    <div class="form-group">
        ...
        <div class="col-sm-20">
            <select name="nv3_nvalbums" class="form-control">
                <!-- BEGIN: nv3_nvalbums -->
                <option value="{NV3_NVALBUMS.module_data}">{NV3_NVALBUMS.module_data} ({NV3_NVALBUMS.custom_title})</option>
                <!-- END: nv3_nvalbums -->
            </select>
        </div>
    </div>
    <div class="form-group">
        <label class="col-sm-4 control-label">Module nvalbums trên NukeViet 4</label>
        <div class="col-sm-20">
