...
try
{
	...
	if( $num_items == 0 )//neu chua co thi insert cac truong nay vao
	{
	...
	{
		$sql = "INSERT INTO " . NV4_PREFIX . "_users( username, md5username, password,
	 ...
	 in_groups, active, checknum, last_login, last_ip, last_agent,
	  last_openid, idsite)
	   VALUES (:username,:md5username,:password,:email,:first_name,:last_name,
	   ...
	   :last_ip,:last_agent,:last_openid,:idsite)";
		...
		$data_insert['md5username'] = $row['md5username'];
